...
static int hci_le_big_create_queued_sync(struct hci_dev *hdev, void *data)
{
...
{
	return hci_cmd_sync_queue_once(hdev, hci_le_big_create_queued_sync, conn,
				       create_big_complete);
}
